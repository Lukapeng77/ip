...
public enum ExceptionTypes {
     ...
     */
    UNKNOWN_COMMAND( "No idea what that means, please give the command with a keyword! List of keywords: \"mark\", \"unmark\", \"list\", \"todo\", \"event\", \"deadline\", \"delete\", \"checkondate\""),
